...
(async () => {
  console.log('Iniciando navegador para superar el reto aes.js para buscar goles de youtube...');
  ...
  const url = `https://perroliga.wuaze.com/crons/cron_buscar_youtube.php?key=${cronKey}`;
