...
(async () => {
  console.log('Iniciando navegador para superar el reto aes.js para actualizar horarios de partidos...');
  ...
  const url = `https://perroliga.wuaze.com/crons/cron_actualizar_fechas.php?key=${cronKey}`;
